...
var signIn = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, userId, password, user, verifyPassword, accessToken, refreshToken;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                user = _b.sent();
                if (!user) {
                    return [2 /*return*/, res.status(401).json({ message: 'Invalid userId' })];
                }
            ...
            case 2:
                ...
                accessToken = (0, jwtUtil_1.generateToken)({ id: user._id });
                refreshToken = (0, jwtUtil_1.generateRefreshToken)();
